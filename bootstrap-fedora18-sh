...
PKG_LIST="yum initscripts passwd rsyslog vim dhclient chkconfig rootfiles policycoreutils openssh-server net-tools"
EXTRA_PKG_LIST="nc traceroute"
...
curl -sf "$RELEASE_URL" > $TMPROOT/fedora-release-$release.noarch.rpm
mkdir -p $ROOTFS/var/lib/rpm
rpm --root $ROOTFS --initdb
rpm --root $ROOTFS -ivh $TMPROOT/fedora-release-$release.noarch.rpm
